...
def main_menu_kb() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🎁 Бонусы UDS", callback_data="loyalty")],
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    text = (
        ...
        "🎁 <b>Получить 500 бонусов</b> за регистрацию в программе лояльности\n"
...
async def register_uds(callback: CallbackQuery):
    ...
    text = (
        "🎁 <b>Регистрация в программе лояльности</b>\n\n"
        "Получи <b>500 бонусов в подарок</b> сразу после регистрации.\n\n"
        "<b>Выбери удобный способ:</b>\n\n"
        "📲 <b>Приложение UDS</b> — самый наглядный\n"
        "✈️ <b>Telegram-бот</b> — если предпочитаешь Telegram\n"
        "📱 <b>MAX-бот</b> — если используешь MAX\n\n"
        "🔔 <b>ВАЖНО:</b> после регистрации <b>обязательно оставь уведомления включёнными</b> — "
        "тогда ты узнаешь о новых акциях, скидках и сертификатах первой и ничего не пропустишь.\n\n"
        "После регистрации на ваш бонусный счёт зачислится 500 бонусов."
    )
    buttons = [
...
async def cmd_bonuses(event, state: FSMContext):
    ...
    text = (
        "🎁 <b>Программа лояльности UDS</b>\n\n"
        "Зарегистрируйся в программе лояльности студии Марии — "
        "и получи <b>500 бонусов в подарок</b> сразу после первой покупки.\n\n"
        "<b>Выбери удобный способ регистрации:</b>\n\n"
        "📲 <b>Приложение UDS</b> — для тех, кто любит наглядно\n"
        "✈️ <b>Telegram-бот</b> — если предпочитаешь Telegram\n"
        "📱 <b>MAX-бот</b> — если используешь MAX\n\n"
        "<b>Что даёт программа после регистрации:</b>\n\n"
        "💰 <b>500 баллов</b> — в подарок за регистрацию\n"
        "✨ <b>Кэшбэк до 7%</b> с каждой покупки\n"
        "💳 <b>Списание баллами</b> до 10% от суммы чека\n"
        "🎂 <b>Бонус на ДР</b> — сертификат 1 000 ₽ за 14 дней до именин\n"
        "👯 <b>+400 баллов</b> за приведённую подругу + 5% кэшбэка с её покупок\n\n"
        "<b>Уровни лояльности:</b>\n"
        "• 🥉 <b>Гость</b> — кэшбэк 2%, списание до 5%\n"
        "• 🥈 <b>Красотка</b> (от 25 000 ₽ + 3 приглашённых) — кэшбэк 5%, списание 7%\n"
        "• 🥇 <b>VIP</b> (от 50 000 ₽ + 5 приглашённых) — кэшбэк 7%, списание 10%\n\n"
        "🔔 <b>ВАЖНО:</b> после регистрации <b>оставь уведомления включёнными</b> — "
        "так ты узнаешь о новых акциях, скидках и сертификатах первой."
    )
    buttons = [
